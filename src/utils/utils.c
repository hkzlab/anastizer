...
IplImage *anastize_image(IplImage *wimg, Uint8 cur_chan) {
	...
	remove_spot_intensity(mimg, wimg, 15 * WARP_MULT + 1, 300 * WARP_MULT, 100, cur_chan, Conn8);
	remove_spot_intensity(mimg, wimg, 300 * WARP_MULT + 1, 400 * WARP_MULT, 15, cur_chan, Conn8);
